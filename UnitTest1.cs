    ...
    public class UnitTest1
    {
        ...
        public void TestCase_01()
        {
           try
           {
                ...
                driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(5);                            // Delay 5 seconds
                ...
                for (int i = 0; i < items.Length; i++)                                                        // Check the list to buy and add to the cart
                {
                    ...
                    driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(5);                        // Delay for 5 seconds
